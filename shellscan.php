...
class shellDetector {
  ...
  private $extension = array('php','txt','Php', 'PhP', 'phP', 'PHp', 'phtml', 'shtml', 'PHP');
  ...
  private $authentication = array("username" => "babiraga", "password" => "babiraga");
  ...
  //system: title
  private $_title = 'Web Shell Detector by Babiraga Shell';

  //system: version of shell detector
  private $_version = '0.666';
